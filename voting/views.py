...
def generate_ballot(display_controls=False):
    ...
    for position in positions:
        ...
        for candidate in candidates:
            ...
            candidates_data = candidates_data + '<li>' + input_box + '<button type="button" class="btn btn-primary btn-sm btn-flat clist platform" data-fullname="'+candidate.fullname+'" data-bio="'+candidate.bio+'"><i class="fa fa-search"></i> Platform</button><span class="cname clist">' + \
